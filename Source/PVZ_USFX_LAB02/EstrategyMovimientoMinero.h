...
#include "EstrategyMovimientoMinero.generated.h"
UCLASS()
class PVZ_USFX_LAB02_API AEstrategyMovimientoMinero : public AActor, public IEstrategy_Planta
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AEstrategyMovimientoMinero();
